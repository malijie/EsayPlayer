...
//	private static final int COLOR_TEXT_NORMAL = Utils.getColor(R.color.viewpager_indicator_red);
	private static final int COLOR_TEXT_NORMAL = Utils.getColor(R.color.white);
	private static final int COLOR_TEXT_HIGHLIGHT = Utils.getColor(R.color.title_bar_text_blue);
